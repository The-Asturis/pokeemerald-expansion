...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_TEMP_6 // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_UNUSED_0x020 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_TEMP_8 // Allow player to find hidden mons
#define DN_VAR_SPECIES                FLAG_TEMP_9 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           FLAG_TEMP_A // Steps for finding hidden pokemon
